import { FileIcon, FileTextIcon, Sparkles } from 'lucide-react'
  ...
  return (
      ...
      >
        ...
        <input
          ...
          required
        />
          <p className='text-xs text-gray-500 font-light mt-1'>Supports PDF form only</p>
        ...
        >{
          loading ? 
          <span className='w-4 h-4 my-1 rounded-full border-2 border-t-transparent animate-pulse'></span>
            : 
